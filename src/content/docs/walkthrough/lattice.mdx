...
![VPC Lattice architecture with service network RAM share and cross-account VPC association](/aws-private-connectivity-patterns-walkthrough/diagrams/lattice.svg)
