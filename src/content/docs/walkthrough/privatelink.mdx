...
![PrivateLink architecture with NLB endpoint service and cross-account interface VPC endpoint](/aws-private-connectivity-patterns-walkthrough/diagrams/privatelink.svg)
