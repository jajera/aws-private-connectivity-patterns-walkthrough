...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img">
  ...
  <text x="72" y="120" fill="#22d3ee" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="26" font-weight="700" letter-spacing="0.06em">AWS · PRIVATE CONNECTIVITY</text>
  <text x="72" y="220" fill="#eef8fa" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="58" font-weight="800">Five patterns,</text>
  <text x="72" y="295" fill="#eef8fa" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="58" font-weight="800">one walkthrough</text>
  <text x="72" y="380" fill="#b7cdd4" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="26">PrivateLink · Lattice · Peering · TGW · Cloud WAN</text>
  ...
  <text x="72" y="560" fill="#5a7a86" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="20">aws-private-connectivity-patterns-walkthrough.johna.kiwi</text>
</svg>
`;
